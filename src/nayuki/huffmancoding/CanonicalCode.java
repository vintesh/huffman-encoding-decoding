 ...
 */
/*
 * A canonical Huffman code only describes the code length of each symbol. The
 * codes can be reconstructed from this information. In this implementation,
 * symbols with lower code lengths, breaking ties by lower symbols, are assigned
 * lexicographically lower codes. Example: Code lengths (canonical code): Symbol
 * A: 1 Symbol B: 3 Symbol C: 0 (no code) Symbol D: 2 Symbol E: 3 Huffman codes
 * (generated from canonical code): Symbol A: 0 Symbol B: 110 Symbol C: None
 * Symbol D: 10 Symbol E: 111
 */
